  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.mTermsOfService.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        paramAnonymousView.putExtra(VisitBlinkFragment.URL_STRING, AboutBlinkActivity.this.getString(2131099959));
        paramAnonymousView.putExtra(VisitBlinkFragment.TITLE_STRING, AboutBlinkActivity.this.getString(2131099714));
        AboutBlinkActivity.this.startActivity(paramAnonymousView);
      }
    });
    this.mPrivacyPolicy = findViewById(2131558529);
    ((TextView)this.mPrivacyPolicy.findViewById(2131558530)).setText(2131099713);
    ...
    this.mPrivacyPolicy.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        paramAnonymousView = new Intent(AboutBlinkActivity.this, VisitBlinkActivity.class);
        paramAnonymousView.putExtra(VisitBlinkFragment.URL_STRING, AboutBlinkActivity.this.getString(2131099913));
        paramAnonymousView.putExtra(VisitBlinkFragment.TITLE_STRING, AboutBlinkActivity.this.getString(2131099713));
        AboutBlinkActivity.this.startActivity(paramAnonymousView);
      }
    });
    try
...
/* Location:              /home/hectorc/Android/Apktool/Blick_output_jar.jar!/com/immediasemi/blink/activities/AboutBlinkActivity.class
