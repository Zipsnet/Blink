    ...
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      BlinkAPI.BlinkOnboardingRequest(null, null, new OnboardBlinkRequest(), new BlinkAPI.BlinkAPICallback()
      {
        public void onError(BlinkError paramAnonymous2BlinkError)
        {
          ...
          {
            return;
            if (Onboard_3_Connect_To_Blink_Fragment.access$306(Onboard_3_Connect_To_Blink_Fragment.this) > 0) {
              break;
            }
          } while (Onboard_3_Connect_To_Blink_Fragment.this.getActivity() == null);
          new AlertDialog.Builder(Onboard_3_Connect_To_Blink_Fragment.this.getActivity()).setTitle("Error").setMessage("Could not connect to Sync Module").setPositiveButton(2131099886, new DialogInterface.OnClickListener()
          {
          ...
          return;
          Onboard_3_Connect_To_Blink_Fragment.this.handler.sendEmptyMessageDelayed(0, 5000L);
        }
        ...
        public void onResult(BlinkData paramAnonymous2BlinkData)
        {
          ...
          {
            return;
            Onboard_3_Connect_To_Blink_Fragment.access$002(Onboard_3_Connect_To_Blink_Fragment.this, (AccessPoints)paramAnonymous2BlinkData);
...
/* Location:              /home/hectorc/Android/Apktool/Blick_output_jar.jar!/com/immediasemi/blink/fragments/Onboard_3_Connect_To_Blink_Fragment.class
